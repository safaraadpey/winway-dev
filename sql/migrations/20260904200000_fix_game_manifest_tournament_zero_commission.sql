-- Tournament zero-price tickets skip fn_record_ticket_commission at join
-- (entry fee is collected on registration). The waiting→playing manifest
-- must not require commissions_log for those tickets or rooms stay waiting.
