...
-- Admin create tournament: support configurable min_players_to_start (meta), minimum 3.
...
-- Admin update tournament: validate min_players_to_start in meta with minimum 3.
...
-- Canonical tick function: configurable min players from meta.min_players_to_start (minimum enforced to 3).
