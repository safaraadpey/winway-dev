-- M1 fix: force evaluation of tournament accumulation CTE in rpc_apply_ding_credits_for_draw.
-- The tourn CTE was previously unreferenced and pruned by PostgreSQL.
