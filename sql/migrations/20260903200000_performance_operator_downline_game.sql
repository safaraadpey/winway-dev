-- Operator downline player_winnings / cards_amount on agent+super daily rows.
-- Rollup from player_affiliation + per-day player_cards/player_normal_wins (08:00 Tehran window).
