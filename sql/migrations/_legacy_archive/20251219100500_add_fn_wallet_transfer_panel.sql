...
-- Atomic, two-sided transfer for admin panel cashdesk.
-- Actor is derived ONLY from auth.uid() (no actor_id input).
-- Currency is restricted to IRR.
...
begin
  ...
  -- Only IRR supported by this panel transfer.
  -- (wallets table is effectively single-currency in this project due to unique(user_id))
