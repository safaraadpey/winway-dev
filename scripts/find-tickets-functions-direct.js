...
console.log('1️⃣  در Supabase Dashboard → SQL Editor → فایل find_tickets_functions.sql را اجرا کنید\n');
console.log('2️⃣  یا از psql استفاده کنید:\n');
console.log(`   psql "postgresql://postgres:[PASSWORD]@[HOST]:5432/postgres" -f find_tickets_functions.sql\n`);
...
console.log('💡 برای اجرای سریع، فایل find_tickets_functions.sql را در Supabase SQL Editor باز کنید.\n');
