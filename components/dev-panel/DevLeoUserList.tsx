          ...
          <div className="min-w-0">
            ...
            <div className="mt-0.5 truncate text-xs text-gray-400">
              ...
              {selectedOperator
                ...
                ? `${selectedOperator.displayName} (${operatorRoleLabel(selectedOperator.role)})`
            ...
            return (
              ...
              <div key={user.userId} className="overflow-hidden rounded-xl border border-gray-800">
                ...
                <button
                  ...
                  className={`flex w-full items-center justify-between gap-3 bg-[#151515] px-4 py-3 text-right transition-colors ${
                  ...
                  <div className="flex shrink-0 items-center gap-2">
                    ...
                    <div className="flex flex-col items-end gap-1">
                      ...
                      {user.leoEnabled ? (
                        ...
                        <span className="rounded-full bg-emerald-900/40 px-2 py-0.5 text-[10px] font-semibold text-emerald-200">
