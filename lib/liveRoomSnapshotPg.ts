...
/** Temporary compare logging — remove after 2026-06-17 UTC. */
...
export async function loadLiveDrawsFromPg(
  ...
  try {
    ...
    console.error("loadLiveDrawsFromPg error:", err);
    return null;
  }
}
...
export async function loadLiveTicketsFromPg(
  ...
  try {
    ...
    console.error("loadLiveTicketsFromPg error:", err);
    return null;
  }
}
...
export async function loadLiveCardNumbersFromPg(
  ...
  try {
    ...
    console.error("loadLiveCardNumbersFromPg error:", err);
    return null;
  }
}
