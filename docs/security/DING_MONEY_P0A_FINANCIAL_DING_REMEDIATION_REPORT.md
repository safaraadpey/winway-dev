...
| `apps/engines/bingo/src/finance/index.ts` | `fn_wallet_apply_delta`, `fn_finish_room_and_settle`, commission RPCs | **service_role** |
| `apps/engines/bingo/src/repositories/index.ts` | `rpc_apply_ding_credits_for_draw`, `rpc_finalize_engine_draw_job` (17-arg) | **service_role** |
| `apps/engines/bingo/src/domain/draw/processDrawBatch.ts`, `reconcileWinners.ts` | `fn_evaluate_room_after_draw` | **service_role** |
| `apps/engines/bingo/src/domain/room/janitorRepair.ts` | `fn_janitor_repair_unsettled_finished` | **service_role** |
