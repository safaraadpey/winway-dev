...
| Engine `/v1/lobby` | Yes | `apps/engines/bingo/src/http/server.ts` |
| Engine `/v1/gameroom` | Yes | `apps/engines/bingo/src/http/server.ts` |
| Engine `/v1/rooms/join` | Yes | `apps/engines/bingo/src/http/server.ts` |
| CORS for browser | Yes | `apps/engines/bingo/src/http/cors.ts` |
